...
export default {
  data: new SlashCommandBuilder().setName("fixme").setDescription("Get the worst possible advice for your problem.").setIntegrationTypes(0, 1).setContexts(0, 1, 2).addStringOption((option: any) => option.setName("problem").setDescription("Describe your problem (e.g., 'broke', 'love', 'school')").setRequired(true)),
