...
import { processAndTranslate, LANGUAGES } from "../../handlers/translations/translationHandler";
export default {
  data: new ContextMenuCommandBuilder().setName('Translate Image').setType(ApplicationCommandType.Message).setIntegrationTypes(0, 1).setContexts(0, 1, 2),
